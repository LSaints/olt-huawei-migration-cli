...
from core.infra import OntRepository, ClientTelnet
...
class OntServices:
    ...
    def __init__(self):
        ...
        self.__repository = OntRepository(cliente=self.__client_telnet)
    ...
    async def definir_client_olt(self, host: str, usuario: str, senha: str, porta: str = 23):
        self.__client_telnet = ClientTelnet(
            host=host,
            usuario=usuario,
            senha=senha,
        ...
        await self.__client_telnet.conectar()
